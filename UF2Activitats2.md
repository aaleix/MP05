...
- Codi del programa.
- Captura de pantalla de com li passeu a IntelliJ com programa d'argument un número.
- Captura de com feu un punt d'interrupció al bucle de creació de la matriu.
